...
import type { ArchitectGuardrails } from '../fingerprint/guardrails-builder.js'
import type { WorkspaceMapEntry } from '../fingerprint/workspace-types.js'

export type { WorkspaceMapEntry }
...
export interface GeneratorInput {
  ...
  readonly architectGuardrails?: ArchitectGuardrails
  /** Present when generating the root aggregate of a monorepo */
  readonly workspaceMap?: readonly WorkspaceMapEntry[]
  /** Relative paths to unmanaged .claude/commands/*.md files not generated by openskulls */
