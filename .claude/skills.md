...
`/add-ai-engine` — Use when adding support for a new AI coding CLI engine to openskulls. Triggers: new AI tool, new engine, new generator, AICLIAdapter, AI_CLI_CANDIDATES, detectAICLIs, AICLISignal, ENGINE_TO_TOOL, ALL_TARGETS, AGENTS.md, cursor, windsurf, cline.
